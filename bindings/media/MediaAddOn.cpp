...
.def("__copy__", py::overload_cast<const dormant_flavor_info &>(&dormant_flavor_info::operator=), "", py::arg("other"))
.def("__copy__", py::overload_cast<const flavor_info &>(&dormant_flavor_info::operator=), "", py::arg("other"))
