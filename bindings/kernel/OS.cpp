...
*/
m.attr("B_IDLE_PRIORITY") = B_IDLE_PRIORITY;
m.attr("B_LOWEST_ACTIVE_PRIORITY") = B_LOWEST_ACTIVE_PRIORITY;
m.attr("B_LOW_PRIORITY") = B_LOW_PRIORITY;
m.attr("B_NORMAL_PRIORITY") = B_NORMAL_PRIORITY;
m.attr("B_DISPLAY_PRIORITY") = B_DISPLAY_PRIORITY;
m.attr("B_URGENT_DISPLAY_PRIORITY") = B_URGENT_DISPLAY_PRIORITY;
m.attr("B_REAL_TIME_DISPLAY_PRIORITY") = B_REAL_TIME_DISPLAY_PRIORITY;
m.attr("B_URGENT_PRIORITY") = B_URGENT_PRIORITY;
m.attr("B_REAL_TIME_PRIORITY") = B_REAL_TIME_PRIORITY;
